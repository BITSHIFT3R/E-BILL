...
public class Bill_Preview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      System.out.println("presrd"+presrd+"\n"+"prevrd"+prevrd+"\n"
       ...
       accno= (TextView)v.findViewById(R.id.bpan);
        ...
        grsAmt.setVisibility(View.INVISIBLE);
       // pdf=(Button)v.findViewById(R.id.);
        ...
        pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                File myDir = new File(root + "/CHINHAT");
...
public void store()
{
    System.out.println("location On php"+email+"-"+location);
    ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
    HttpClient httpclient = new DefaultHttpClient();
    HttpPost httppost = new HttpPost("http://49.50.71.97:88/chinhat/transaction.php");
    nameValuePairs.add(new BasicNameValuePair("acno",bdate));
    nameValuePairs.add(new BasicNameValuePair("pdate",Previousdate));
    nameValuePairs.add(new BasicNameValuePair("mf","1.00"));
    nameValuePairs.add(new BasicNameValuePair("cmd",cmd1));
    nameValuePairs.add(new BasicNameValuePair("ckwh",OverALLReading));
    nameValuePairs.add(new BasicNameValuePair("pkwh",PreviousReadin));
    nameValuePairs.add(new BasicNameValuePair("ckvwh",currentKVWH));
    nameValuePairs.add(new BasicNameValuePair("pkvwh",PreviousKVWH));
    nameValuePairs.add(new BasicNameValuePair("energychge",ddate));
    nameValuePairs.add(new BasicNameValuePair("fxdcharge",ubill));
    nameValuePairs.add(new BasicNameValuePair("minchge",minchrg));
    nameValuePairs.add(new BasicNameValuePair("eduty",ElecticityDuty));
    nameValuePairs.add(new BasicNameValuePair("regcharge",rgchrg));
    nameValuePairs.add(new BasicNameValuePair("penality",EXDamagePanality));
    nameValuePairs.add(new BasicNameValuePair("arrearamt",arramt));
    nameValuePairs.add(new BasicNameValuePair("arrearcharge",ArrSurChrgs));
    nameValuePairs.add(new BasicNameValuePair("curcharge",CurSurChrgs));
    nameValuePairs.add(new BasicNameValuePair("AdjstAmt",AdjstAmt));
    nameValuePairs.add(new BasicNameValuePair("email",email));
    nameValuePairs.add(new BasicNameValuePair("bamt",bamt));
    nameValuePairs.add(new BasicNameValuePair("rebate",REBATE));
    nameValuePairs.add(new BasicNameValuePair("gamt",grossammount));
    nameValuePairs.add(new BasicNameValuePair("Image",Imagepart));
