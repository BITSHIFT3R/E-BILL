...
public class cameraforproof extends ActionBarActivity {
	...
	String message,set,acno,email;
	 ...
	 MediaPlayer mp=new MediaPlayer();
		static final String URL_ALBUMS = "http://www.aditya.multifacet-software.com/kesco/store/image_proof.php";
	@Override
...
//		             startActivityForResult(intent, 1);
		...
		txt2.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					gps = new GPSTracker(cameraforproof.this);
...
//                 txt9.setText(selectedImagePath);
    ...
    class ImageUploadTask extends AsyncTask<Void, Void, String> {
   	  protected void onPreExecute() {
  			super.onPreExecute();
  			dialog = ProgressDialog.show(cameraforproof.this, "Image Uploading",
  					"Please wait...", true);
