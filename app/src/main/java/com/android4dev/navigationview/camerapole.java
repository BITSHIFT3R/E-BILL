...
public class camerapole extends ActionBarActivity {
	...
	String message,set,acno,email;
	 ...
	 MediaPlayer mp=new MediaPlayer();
		static final String URL_ALBUMS = "http://www.aditya.multifacet-software.com/kesco/image_pole.php";
	@Override
...
//		             startActivityForResult(intent, 1);
		...
		txt2.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					gps = new GPSTracker(camerapole.this);
...
//                 txt9.setText(selectedImagePath);
    ...
    class ImageUploadTask extends AsyncTask<Void, Void, String> {
   	  protected void onPreExecute() {
  			super.onPreExecute();
  			dialog = ProgressDialog.show(camerapole.this, "Image Uploading",
  					"Please wait...", true);
